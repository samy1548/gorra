...
const imagenesPorModelo = {
    gorra1: {
        Negro: { src: "imagen/10.jpeg", alt: 'Gorra Negro', nombre: 'Gorra Con Estampado de Oso' },
    ...
    gorra2: {
        ...
        Negro: { src: "./imagen/1/1.jpeg", alt: 'Gorra Negro', nombre: 'Gorra Con Estampado de Oso' },
    ...
    gorra3: {
        NegroConBlanco: { src: './imagen/2/2.jpeg', alt: 'Gorra Negro Con Blanco', nombre: 'Gorra Con Cara de Fantasma' },
        Negro: { src: './imagen/2/3.jpeg', alt: 'Gorra Negro', nombre: 'Gorra Con Cara de Fantasma' },
    ...
    gorra5: {
        AzulClaro: { src: './imagen/4/3.jpeg', alt: 'Gorra Azul Claro', nombre: 'Gorra Con Bordado de Cruz' },
        Blanco: { src: './imagen/4/2.jpeg', alt: 'Gorra Blanco', nombre: 'Gorra Con Bordado de Cruz' },
        Negro: { src: './imagen/4/1.jpeg', alt: 'Gorra  Negro', nombre: 'Gorra Con Bordado de Cruz' },
        NegroConBlanco: { src: './imagen/4/4.jpeg', alt: 'Gorra Negro Con Blanco', nombre: 'Gorra Con Bordado de Cruz' },
        Rojo: { src: './imagen/4/5.jpeg', alt: 'Gorra Rojo', nombre: 'Gorra de SD Bordada' },
        Marron: { src: './imagen/4/6.jpeg', alt: 'Gorra Marron', nombre: 'Gorra Con Bordado de Cruz' },
    },
    gorra6: {
       AzulMarino: { src: './imagen/5/1.jpeg', alt: 'Gorra Azul Marino', nombre: 'Gorra Con DIbujo Animado' },
        Caqui: { src: './imagen/5/2.jpeg', alt: 'Gorra Caqui', nombre: 'Gorra Con DIbujo Animado' },
        Azul: { src: './imagen/5/3.jpeg', alt: 'Gorra  Azul', nombre: 'Gorra Con DIbujo Animado' },
        Marron: { src: './imagen/5/4.jpeg', alt: 'Gorra Marron', nombre: 'Gorra Con DIbujo Animado' },
        Gris: { src: './imagen/5/5.jpeg', alt: 'Gorra Gris', nombre: 'Gorra Con DIbujo Animado' },
        VerdeMenta: { src: './imagen/5/6.jpeg', alt: 'Gorra Verde Menta', nombre: 'Gorra Con DIbujo Animado' },
        Amarillo: { src: './imagen/5/7.jpeg', alt: 'Gorra Amarillo', nombre: 'Gorra Con DIbujo Animado' },
        Naranja: { src: './imagen/5/8.jpeg', alt: 'Gorra Naranja', nombre: 'Gorra Con DIbujo Animado' },
    }
};
